    ...
    <div class="flex justify-between items-center px-6 md:px-12 py-4">
        ...
        <div class="hidden md:flex items-center gap-7 flex-1">
            <a href="{{ route('shop.index') }}"
               class="text-xs uppercase tracking-[0.15em] font-semibold hover:text-brand-gray-medium transition-colors duration-200 focus:outline-none focus:underline {{ request()->routeIs('shop.*') ? 'underline underline-offset-4' : '' }}">
                ร้าน
            </a>

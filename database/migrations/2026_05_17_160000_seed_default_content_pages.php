...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $thaiBody = [
            ...
            'returns' => "สามารถแจ้งเปลี่ยนหรือคืนสินค้าได้ภายใน 7 วัน เมื่อสินค้าอยู่ในสภาพสมบูรณ์ ไม่ผ่านการใช้งาน และมีหลักฐานการสั่งซื้อ\n\nสินค้าที่ผลิตเฉพาะหรือปรับแต่งพิเศษอาจมีเงื่อนไขเพิ่มเติม",
        ...
        $englishBody = [
            ...
            'returns' => 'Returns or exchanges can be requested within 7 days when items are unused, complete, and accompanied by proof of purchase.',
